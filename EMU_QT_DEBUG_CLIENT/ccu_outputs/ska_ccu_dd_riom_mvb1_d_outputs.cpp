    ...
    : QObject{parent}
{
    ...
    //std::fill(m_ska_ccu_dd_riom_mvb1_d_outputs.begin(), m_ska_ccu_dd_riom_mvb1_d_outputs.end(), 0);

    memset(m_ska_ccu_dd_riom_mvb1_d_outputs.data(), 0, sizeof(m_ska_ccu_dd_riom_mvb1_d_outputs));
...
void Ska_Ccu_DD_Riom_Mvb1_d_Outputs::init_ska2_table()
{
    ...
    QStringList table_name = {"ska_2_ccu_dd_riom_mvb1_d", "value"};
...
void Ska_Ccu_DD_Riom_Mvb1_d_Outputs::set_struct(SKA_VEHICLE_NUM ska_x_num)
{

    int ska_num = static_cast<int>(ska_x_num);
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit0 = m_outputs_map[ska_num].at("bit0")                                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit1 = m_outputs_map[ska_num].at("bit1")                                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.MODE_PARKING_ON = m_outputs_map[ska_num].at("MODE_PARKING_ON")                          ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.SIGNALING_AIR_SUSPENSION_FAILURE = m_outputs_map[ska_num].at("SIGNALING_AIR_SUSPENSION_FAILURE")         ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit4 = m_outputs_map[ska_num].at("bit4")                                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit5 = m_outputs_map[ska_num].at("bit5")                                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit6 = m_outputs_map[ska_num].at("bit6")                                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.CONTROL_DESK_TEST_HW_HEALT_RIOM_1 = m_outputs_map[ska_num].at("CONTROL_DESK_TEST_HW_HEALT_RIOM_1")        ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit8 = m_outputs_map[ska_num].at("bit8")                                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.WFL_SPRAY_ENABLE = m_outputs_map[ska_num].at("WFL_SPRAY_ENABLE")                         ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.WFL_DIRECTION = m_outputs_map[ska_num].at("WFL_DIRECTION")                            ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.EMERGENCY_EGRESS_DEVICE_OUTPUT = m_outputs_map[ska_num].at("EMERGENCY_EGRESS_DEVICE_OUTPUT")           ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.BY_PASS_HATCH_UNLOCK = m_outputs_map[ska_num].at("BY_PASS_HATCH_UNLOCK")                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.HATCH_UNLOCK = m_outputs_map[ska_num].at("HATCH_UNLOCK")                             ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.COMMAND_OPENING_HATCH = m_outputs_map[ska_num].at("COMMAND_OPENING_HATCH")                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.COMMAND_CLOSING_HATCH = m_outputs_map[ska_num].at("COMMAND_CLOSING_HATCH")                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.WIPER_MIDDLE_POSITION_REQUEST = m_outputs_map[ska_num].at("WIPER_MIDDLE_POSITION_REQUEST")            ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.DIMMED_HEAD_LIGHT_LEFT_CENTRAL = m_outputs_map[ska_num].at("DIMMED_HEAD_LIGHT_LEFT_CENTRAL")           ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.TAIL_RED_LIGHT_LEFT = m_outputs_map[ska_num].at("TAIL_RED_LIGHT_LEFT")                      ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.DIMMED_MARKER_LIGHT_LEFT_RIGHT_CENTRAL = m_outputs_map[ska_num].at("DIMMED_MARKER_LIGHT_LEFT_RIGHT_CENTRAL")   ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit20 = m_outputs_map[ska_num].at("bit20")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit21 = m_outputs_map[ska_num].at("bit21")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit22 = m_outputs_map[ska_num].at("bit22")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit23 = m_outputs_map[ska_num].at("bit23")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.TAIL_RED_LIGHT_RIGHT = m_outputs_map[ska_num].at("TAIL_RED_LIGHT_RIGHT")                     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.DIMMED_MARKER_LIGHT_LEFT_RIGHT_CENTRAL = m_outputs_map[ska_num].at("DIMMED_MARKER_LIGHT_LEFT_RIGHT_CENTRAL")   ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.FULL_MARKER_LIGHT_LEFT_RIGHT_CENTRAL = m_outputs_map[ska_num].at("FULL_MARKER_LIGHT_LEFT_RIGHT_CENTRAL")     ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.FULL_HEAD_LIGHT_LEFT_RIGHT_CENTRAL = m_outputs_map[ska_num].at("FULL_HEAD_LIGHT_LEFT_RIGHT_CENTRAL")       ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit28 = m_outputs_map[ska_num].at("bit28")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit29 = m_outputs_map[ska_num].at("bit29")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit30 = m_outputs_map[ska_num].at("bit30")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.bit31 = m_outputs_map[ska_num].at("bit31")                                    ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.reserved4 = m_outputs_map[ska_num].at("reserved4")                                ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.reserved5 = m_outputs_map[ska_num].at("reserved5")                                ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.reserved6 = m_outputs_map[ska_num].at("reserved6")                                ;
        m_ska_ccu_dd_riom_mvb1_d_outputs.at(ska_num).bits.reserved7 = m_outputs_map[ska_num].at("reserved7")                                ;
