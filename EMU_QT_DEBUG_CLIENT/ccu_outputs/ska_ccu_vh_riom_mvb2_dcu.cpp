...
void Ska_Ccu_Vh_Riom_Mvb2_Dcu::update_struct_with_map(SKA_VEHICLE_NUM ska_x_num)
{
...
void Ska_Ccu_Vh_Riom_Mvb2_Dcu::init_ska1_table()
{
    ...
    m_tableWidget[get_index(SKA_VEHICLE_NUM::SKA1)]->setObjectName("ska_1_ccu_vh_riom_mvb2_dcu_hvac_fdu");
...
void Ska_Ccu_Vh_Riom_Mvb2_Dcu::init_ska2_table()
{
    ...
    m_tableWidget[get_index(SKA_VEHICLE_NUM::SKA2)]->setObjectName("ska_2_ccu_vh_riom_mvb2_dcu_hvac_fdu");
    int row = 0;
...
void Ska_Ccu_Vh_Riom_Mvb2_Dcu::set_struct(SKA_VEHICLE_NUM ska_x_num)
{
        int ska_num = static_cast<int>(ska_x_num);
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R1_TCMS_EEDreset = m_outputs_map[ska_num].at("R1_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R2_TCMS_EEDreset = m_outputs_map[ska_num].at("R2_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R3_TCMS_EEDreset = m_outputs_map[ska_num].at("R3_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R4_TCMS_EEDreset = m_outputs_map[ska_num].at("R4_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L1_TCMS_EEDreset = m_outputs_map[ska_num].at("L1_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L2_TCMS_EEDreset = m_outputs_map[ska_num].at("L2_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L3_TCMS_EEDreset = m_outputs_map[ska_num].at("L3_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L4_TCMS_EEDreset = m_outputs_map[ska_num].at("L4_TCMS_EEDreset")                ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R1_TCMS_TLRelease = m_outputs_map[ska_num].at("R1_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R2_TCMS_TLRelease = m_outputs_map[ska_num].at("R2_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R3_TCMS_TLRelease = m_outputs_map[ska_num].at("R3_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R4_TCMS_TLRelease = m_outputs_map[ska_num].at("R4_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L1_TCMS_TLRelease = m_outputs_map[ska_num].at("L1_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L2_TCMS_TLRelease = m_outputs_map[ska_num].at("L2_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L3_TCMS_TLRelease = m_outputs_map[ska_num].at("L3_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L4_TCMS_TLRelease = m_outputs_map[ska_num].at("L4_TCMS_TLRelease")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R1_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("R1_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R2_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("R2_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R3_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("R3_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R4_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("R4_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L1_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("L1_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L2_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("L2_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L3_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("L3_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L4_TCMS_LoopLSDoorNotEmergOp = m_outputs_map[ska_num].at("L4_TCMS_LoopLSDoorNotEmergOp")    ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R1_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("R1_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R2_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("R2_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R3_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("R3_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R4_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("R4_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L1_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("L1_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L2_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("L2_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L3_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("L3_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L4_TCMS_DoorFullyOpen = m_outputs_map[ska_num].at("L4_TCMS_DoorFullyOpen")           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R1_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("R1_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R2_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("R2_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R3_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("R3_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.R4_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("R4_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L1_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("L1_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L2_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("L2_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L3_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("L3_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.L4_TCMS_TLCentrOpen = m_outputs_map[ska_num].at("L4_TCMS_TLCentrOpen")             ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_5 = m_outputs_map[ska_num].at("reserved_5")                      ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_6 = m_outputs_map[ska_num].at("reserved_6")                      ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_7 = m_outputs_map[ska_num].at("reserved_7")                      ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit64 = m_outputs_map[ska_num].at("bit64")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVACC_Reduce_Mode = m_outputs_map[ska_num].at("HVACC_Reduce_Mode")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit66 = m_outputs_map[ska_num].at("bit66")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVACC_Cabin_Active = m_outputs_map[ska_num].at("HVACC_Cabin_Active")              ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVACC_Automatic_Dumper_Switch = m_outputs_map[ska_num].at("HVACC_Automatic_Dumper_Switch")   ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVACC_Close_Dumper = m_outputs_map[ska_num].at("HVACC_Close_Dumper")              ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit70 = m_outputs_map[ska_num].at("bit70")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit71 = m_outputs_map[ska_num].at("bit71")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC1_HVAC_On = m_outputs_map[ska_num].at("HVAC1_HVAC_On")                   ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC1_Reduce_Mode = m_outputs_map[ska_num].at("HVAC1_Reduce_Mode")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC1_Door_Open = m_outputs_map[ska_num].at("HVAC1_Door_Open")                 ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit75 = m_outputs_map[ska_num].at("bit75")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC1_Automatic_Dumper_Switch = m_outputs_map[ska_num].at("HVAC1_Automatic_Dumper_Switch")   ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC1_Close_Dumper = m_outputs_map[ska_num].at("HVAC1_Close_Dumper")              ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit78 = m_outputs_map[ska_num].at("bit78")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit79 = m_outputs_map[ska_num].at("bit79")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC2_HVAC_On = m_outputs_map[ska_num].at("HVAC2_HVAC_On")                   ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC2_Reduce_Mode = m_outputs_map[ska_num].at("HVAC2_Reduce_Mode")               ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC2_Door_Open = m_outputs_map[ska_num].at("HVAC2_Door_Open")                 ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit83 = m_outputs_map[ska_num].at("bit83")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC2_Automatic_Dumper_Switch = m_outputs_map[ska_num].at("HVAC2_Automatic_Dumper_Switch")   ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.HVAC2_Close_Dumper = m_outputs_map[ska_num].at("HVAC2_Close_Dumper")              ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit86 = m_outputs_map[ska_num].at("bit86")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit87 = m_outputs_map[ska_num].at("bit87")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_11 = m_outputs_map[ska_num].at("reserved_11")                     ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.C_RstFduX = m_outputs_map[ska_num].at("C_RstFduX")                       ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit97 = m_outputs_map[ska_num].at("bit97")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.C_Resound = m_outputs_map[ska_num].at("C_Resound")                       ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit99 = m_outputs_map[ska_num].at("bit99")                           ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit100 = m_outputs_map[ska_num].at("bit100")                          ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit101 = m_outputs_map[ska_num].at("bit101")                          ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit102 = m_outputs_map[ska_num].at("bit102")                          ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.bit103 = m_outputs_map[ska_num].at("bit103")                          ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_13 = m_outputs_map[ska_num].at("reserved_13")                     ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_14 = m_outputs_map[ska_num].at("reserved_14")                     ;
        m_ska_ccu_vh_riom_mvb2_dcu.at(ska_num).bits.reserved_15 = m_outputs_map[ska_num].at("reserved_15")                     ;
}
