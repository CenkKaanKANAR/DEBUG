    ...
    : QObject{parent}
{
    init_oa1_table();
    init_oa2_table();
    memset(m_oa_ccu_vh_riom_mvb1_d_outputs.data(), 0, sizeof(m_oa_ccu_vh_riom_mvb1_d_outputs));
}
...
void Oa_Ccu_Vh_Riom_Mvb1_d_Outputs::set_struct(OA_VEHICLE_NUM oa_x_num)
{
    int oa_num = static_cast<int>(oa_x_num);

        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.COMMAND_CONTACTOR_PRIVILEGED_LOAD_Lp =              m_outputs_map[oa_num].at("COMMAND_CONTACTOR_PRIVILEGED_LOAD_Lp")             ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TCMS_IN_RUN =               m_outputs_map[oa_num].at("TCMS_IN_RUN")                                      ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.INIBHIT_APS =               m_outputs_map[oa_num].at("INIBHIT_APS")                                      ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.DEGRADE_MODE_MV_OA_CARS =               m_outputs_map[oa_num].at("DEGRADE_MODE_MV_OA_CARS")                          ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit4 =              m_outputs_map[oa_num].at("bit4")                                             ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit5 =              m_outputs_map[oa_num].at("bit5")                                             ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit6 =              m_outputs_map[oa_num].at("bit6")                                             ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.CABINET_TEST_HW_HEALT_RIOM_1 =              m_outputs_map[oa_num].at("CABINET_TEST_HW_HEALT_RIOM_1")                     ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.VCB_CLOSING_COMMAND_1 =                 m_outputs_map[oa_num].at("VCB_CLOSING_COMMAND_1")                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.VCB_CLOSING_COMMAND_2 =                 m_outputs_map[oa_num].at("VCB_CLOSING_COMMAND_2")                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.VCB_OPENING_COMMAND =               m_outputs_map[oa_num].at("VCB_OPENING_COMMAND")                              ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.OPENING_HV_DISCONNECTOR =               m_outputs_map[oa_num].at("OPENING_HV_DISCONNECTOR")                          ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit12 =                 m_outputs_map[oa_num].at("bit12")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit13 =                 m_outputs_map[oa_num].at("bit13")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit14 =                 m_outputs_map[oa_num].at("bit14")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit15 =                 m_outputs_map[oa_num].at("bit15")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.CLOSING_HV_DISCONNECTOR =               m_outputs_map[oa_num].at("CLOSING_HV_DISCONNECTOR")                          ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.PANTOGRAPH_COMMAND_MOTOR_COMPRESSOR_OUTPUT =                m_outputs_map[oa_num].at("PANTOGRAPH_COMMAND_MOTOR_COMPRESSOR_OUTPUT")       ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.PANTOGRAPH_COMMAND_RAISING_VALVE =              m_outputs_map[oa_num].at("PANTOGRAPH_COMMAND_RAISING_VALVE")                 ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.ADD_LOOP_CONTROL =              m_outputs_map[oa_num].at("ADD_LOOP_CONTROL")                                 ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit20 =                 m_outputs_map[oa_num].at("bit20")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit21 =                 m_outputs_map[oa_num].at("bit21")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit22 =                 m_outputs_map[oa_num].at("bit22")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit23 =                 m_outputs_map[oa_num].at("bit23")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRAFO_CONTROL_VOLTAGE_LOW_SPEED =               m_outputs_map[oa_num].at("TRAFO_CONTROL_VOLTAGE_LOW_SPEED")                  ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRAFO_CONTROL_VOLTAGE_FULL_SPEED =              m_outputs_map[oa_num].at("TRAFO_CONTROL_VOLTAGE_FULL_SPEED")                 ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.HVAC_1_ON_OFF =                 m_outputs_map[oa_num].at("HVAC_1_ON_OFF")                                    ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.HVAC_1_FAILURE =                m_outputs_map[oa_num].at("HVAC_1_FAILURE")                                   ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit28 =                 m_outputs_map[oa_num].at("bit28")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit29 =                 m_outputs_map[oa_num].at("bit29")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit30 =                 m_outputs_map[oa_num].at("bit30")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit31 =                 m_outputs_map[oa_num].at("bit31")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.HVAC_2_ON_OFF =                 m_outputs_map[oa_num].at("HVAC_2_ON_OFF")                                    ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.HVAC_2_FAILURE =                m_outputs_map[oa_num].at("HVAC_2_FAILURE")                                   ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.MOTOR_COMPRESSOR =              m_outputs_map[oa_num].at("MOTOR_COMPRESSOR")                                 ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit35 =                 m_outputs_map[oa_num].at("bit35")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit36 =                 m_outputs_map[oa_num].at("bit36")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit37 =                 m_outputs_map[oa_num].at("bit37")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit38 =                 m_outputs_map[oa_num].at("bit38")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit39 =                 m_outputs_map[oa_num].at("bit39")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.START_COMPRESSOR =              m_outputs_map[oa_num].at("START_COMPRESSOR")                                 ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TL_HB_C_RELEASE =               m_outputs_map[oa_num].at("TL_HB_C_RELEASE")                                  ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRAIN_IN_MOVING_TO_ACTIVE_SKA_FRONT_DIRECTION =                 m_outputs_map[oa_num].at("TRAIN_IN_MOVING_TO_ACTIVE_SKA_FRONT_DIRECTION")    ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.SLEEPING_SIGNAL_ETCS =              m_outputs_map[oa_num].at("SLEEPING_SIGNAL_ETCS")                             ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRACTION_BRAKE_HANDLE_TRACTION_SIGNAL_ETCS =                m_outputs_map[oa_num].at("TRACTION_BRAKE_HANDLE_TRACTION_SIGNAL_ETCS")       ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRACTION_BRAKE_HANDLE_BRAKE_SIGNAL_ETCS =               m_outputs_map[oa_num].at("TRACTION_BRAKE_HANDLE_BRAKE_SIGNAL_ETCS")          ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.NON_LEADING_SIGNAL_ETCS =               m_outputs_map[oa_num].at("NON_LEADING_SIGNAL_ETCS")                          ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRAIN_INTEGRITY_SIGNAL_ETCS =               m_outputs_map[oa_num].at("TRAIN_INTEGRITY_SIGNAL_ETCS")                      ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRAIN_IN_MOVING_TO_OPPOSITE_ACTIVE_SKA_DIRECTION =              m_outputs_map[oa_num].at("TRAIN_IN_MOVING_TO_OPPOSITE_ACTIVE_SKA_DIRECTION") ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.BRAKE_DEMAND_FROM_ACTIVE_CABIN =                m_outputs_map[oa_num].at("BRAKE_DEMAND_FROM_ACTIVE_CABIN")                   ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.TRACTION_DEMAND_FROM_ACTIVE_CABIN =                 m_outputs_map[oa_num].at("TRACTION_DEMAND_FROM_ACTIVE_CABIN")                ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.CAB_ACTIVATION_SIGNAL =                 m_outputs_map[oa_num].at("CAB_ACTIVATION_SIGNAL")                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit52 =                 m_outputs_map[oa_num].at("bit52")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit53 =                 m_outputs_map[oa_num].at("bit53")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit54 =                 m_outputs_map[oa_num].at("bit54")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.bit55 =                 m_outputs_map[oa_num].at("bit55")                                            ;
        m_oa_ccu_vh_riom_mvb1_d_outputs.at(oa_num).bits.reserved_7 =                m_outputs_map[oa_num].at("reserved_7")                                       ;
...
void Oa_Ccu_Vh_Riom_Mvb1_d_Outputs::update_struct_with_map(OA_VEHICLE_NUM oa_x_num)
{
