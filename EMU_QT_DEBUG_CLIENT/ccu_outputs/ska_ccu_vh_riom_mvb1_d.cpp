...
void Ska_ccu_vh_riom_mvb1_d::init_ska1_table()
{
    ...
    QStringList table_name = {"ska_1_ccu_vh_riom_mvb1_d", "value"};
        ...
        m_tableWidget[get_index(SKA_VEHICLE_NUM::SKA1)]->setObjectName("ska_1_ccu_vh_riom_mvb1_d");
...
void Ska_ccu_vh_riom_mvb1_d::init_ska2_table()
{
    ...
    m_tableWidget[get_index(SKA_VEHICLE_NUM::SKA2)]->setObjectName("ska_2_ccu_vh_riom_mvb1_d");
