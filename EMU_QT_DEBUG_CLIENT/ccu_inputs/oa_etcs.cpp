...
void Oa_Etcs::update_struct_with_map(OA_VEHICLE_NUM oa_x_num, OA_MVB_NUM mvb_num)
{
    ...
    auto setInputMap = [&](const QString& signal_name) {
        ...
        m_inputs_map[oa_num][mvb_num][signal_name] = utils::getTableWidgetValueByNameWithoutColumn(m_tableWidget[oa_num][mvb_num], signal_name);
...
void Oa_Etcs::update_mvb1_map(OA_VEHICLE_NUM oa_x_num)
{
    ...
    //m_inputs_map[oa_num][MVB1].at("Train_Number[12]")          = QString::fromLatin1(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number, 12);
    m_inputs_map[oa_num][MVB1].at("Train_Number[12]") = QString::fromUtf8(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number, 12);
    QVariant value = m_inputs_map[oa_num][MVB1].at("Train_Number[12]");
    if (value.canConvert<QByteArray>()) {
        QByteArray byteArray = value.toByteArray();
        qDebug() << "UPDATE MAP TRAIN NUMBER IS : " << byteArray;
        // Diğer işlemler
    }
    //m_inputs_map[oa_num][MVB1].at("Train_Number[12]")          =std::atoi(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number);
...
void Oa_Etcs::update_table(OA_VEHICLE_NUM oa_x_num, OA_MVB_NUM mvb_num)
{
   ...
   //qDebug() << "UPDATE STRUCT WITH MAP SIZE of COLUMN COUNT ========== :  " << m_tableWidget[oa_num][MVB1]->columnCount() ;
    ...
    for(const auto & map:m_inputs_map[oa_num][mvb_num]){
        ...
        utils::setTableWidgetValueByNameWithoutColumn(m_tableWidget[oa_num][mvb_num], map.first, map.second.toUInt());
...
{
    int oa_num = static_cast<int>(oa_x_num);
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Lifesign              =m_inputs_map[oa_num][MVB1].at("Lifesign").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Valid                 =m_inputs_map[oa_num][MVB1].at("Valid").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit2                  =m_inputs_map[oa_num][MVB1].at("bit2").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit3                  =m_inputs_map[oa_num][MVB1].at("bit3").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit4                  =m_inputs_map[oa_num][MVB1].at("bit4").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit5                  =m_inputs_map[oa_num][MVB1].at("bit5").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit6                  =m_inputs_map[oa_num][MVB1].at("bit6").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit7                  =m_inputs_map[oa_num][MVB1].at("bit7").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_ServiceBrake   =m_inputs_map[oa_num][MVB1].at("OBU_TR_ServiceBrake").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit9                  =m_inputs_map[oa_num][MVB1].at("bit9").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_TCO_Cmd        =m_inputs_map[oa_num][MVB1].at("OBU_TR_TCO_Cmd").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_RBInhibit_Cmd  =m_inputs_map[oa_num][MVB1].at("OBU_TR_RBInhibit_Cmd").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit12                 =m_inputs_map[oa_num][MVB1].at("bit12").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit13                 =m_inputs_map[oa_num][MVB1].at("bit13").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit14                 =m_inputs_map[oa_num][MVB1].at("bit14").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_AT_Cmd         =m_inputs_map[oa_num][MVB1].at("OBU_TR_AT_Cmd").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_MPS_Cmd        =m_inputs_map[oa_num][MVB1].at("OBU_TR_MPS_Cmd").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_PG_Cmd         =m_inputs_map[oa_num][MVB1].at("OBU_TR_PG_Cmd").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_V_Real_Flag    =m_inputs_map[oa_num][MVB1].at("OBU_TR_V_Real_Flag").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_EB_Active_Status = m_inputs_map[oa_num][MVB1].at("OBU_TR_EB_Active_Status").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_EB_Test_Status =m_inputs_map[oa_num][MVB1].at("OBU_TR_EB_Test_Status").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_ETCS_Isolated  =m_inputs_map[oa_num][MVB1].at("OBU_TR_ETCS_Isolated").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit22                 =m_inputs_map[oa_num][MVB1].at("bit22").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit23                 =m_inputs_map[oa_num][MVB1].at("bit23").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_CTS_D_Change   =m_inputs_map[oa_num][MVB1].at("OBU_TR_CTS_D_Change").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.reserved7             =m_inputs_map[oa_num][MVB1].at("reserved7").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.reserved8             =m_inputs_map[oa_num][MVB1].at("reserved8").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.reserved9             =m_inputs_map[oa_num][MVB1].at("reserved9").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_ACC_D_Change   =m_inputs_map[oa_num][MVB1].at("OBU_TR_ACC_D_Change").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_ACC_Limit      =m_inputs_map[oa_num][MVB1].at("OBU_TR_ACC_Limit").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_Train_Speed    =m_inputs_map[oa_num][MVB1].at("OBU_TR_Train_Speed").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_EVC_M_LEVEL    =m_inputs_map[oa_num][MVB1].at("OBU_TR_EVC_M_LEVEL").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.OBU_TR_EVC_M_MODE     =m_inputs_map[oa_num][MVB1].at("OBU_TR_EVC_M_MODE").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit128                =m_inputs_map[oa_num][MVB1].at("bit128").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit129                =m_inputs_map[oa_num][MVB1].at("bit129").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit130                =m_inputs_map[oa_num][MVB1].at("bit130").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit131                =m_inputs_map[oa_num][MVB1].at("bit131").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit132                =m_inputs_map[oa_num][MVB1].at("bit132").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.bit133                =m_inputs_map[oa_num][MVB1].at("bit133").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.EB1_Test_Output       =m_inputs_map[oa_num][MVB1].at("EB1_Test_Output").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.EB2_Test_Output       =m_inputs_map[oa_num][MVB1].at("EB2_Test_Output").toUInt();
    /* Train_Number işlemi
int trainNumber = m_inputs_map[oa_num][MVB1].at("Train_Number[12]").toUInt();
qDebug() << "TRAIN NUMBER IS : " << trainNumber;
snprintf(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number, sizeof(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number), "%d", trainNumber);*/
    // String verisi ile işlem yaparken
    /*QString trainStr = m_inputs_map[oa_num][MVB1].at("Train_Number[12]").toString();
qDebug() << "TRAIN NUMBER IS : " << trainStr;
snprintf(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number,
         sizeof(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number),
         "%s", trainStr.toUtf8().constData());*/

    //Struct'taki güncelleme işlemi
    QString trainStr = m_inputs_map[oa_num][MVB1].at("Train_Number[12]").toString();
    qDebug() << "TRAIN NUMBER IS : " << trainStr;
    snprintf(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number,
             sizeof(m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb1.bits.Train_Number),
    ...
    if (value.canConvert<QString>()) {
        QString trainStr = value.toString();
        qDebug() << "SET STRUCT TRAIN NUMBER IS : " << trainStr;
    }
...
{
    int oa_num = static_cast<int>(oa_x_num);
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Lifesign                  =m_inputs_map[oa_num][MVB2].at("Lifesign").toUInt()                   ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Valid                     =m_inputs_map[oa_num][MVB2].at("Valid").toUInt()                   ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit2                      =m_inputs_map[oa_num][MVB2].at("bit2").toUInt()                      ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit3                      =m_inputs_map[oa_num][MVB2].at("bit3").toUInt()                      ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit4                      =m_inputs_map[oa_num][MVB2].at("bit4").toUInt()                      ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit5                      =m_inputs_map[oa_num][MVB2].at("bit5").toUInt()                      ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit6                      =m_inputs_map[oa_num][MVB2].at("bit6").toUInt()                      ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit7                      =m_inputs_map[oa_num][MVB2].at("bit7").toUInt()                      ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Validity1                 =m_inputs_map[oa_num][MVB2].at("Validity1").toUInt()                 ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Validity2                 =m_inputs_map[oa_num][MVB2].at("Validity2").toUInt()                 ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Validity3                 =m_inputs_map[oa_num][MVB2].at("Validity3").toUInt()                 ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Validity4                 =m_inputs_map[oa_num][MVB2].at("Validity4").toUInt()                 ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.Validity5                 =m_inputs_map[oa_num][MVB2].at("Validity5").toUInt()                 ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit13                     =m_inputs_map[oa_num][MVB2].at("bit13").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit14                     =m_inputs_map[oa_num][MVB2].at("bit14").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit15                     =m_inputs_map[oa_num][MVB2].at("bit15").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Left1           =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Left1").toUInt()           ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Right1          =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Right1").toUInt()          ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit18                     =m_inputs_map[oa_num][MVB2].at("bit18").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit19                     =m_inputs_map[oa_num][MVB2].at("bit19").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height1_Bit0    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height1_Bit0").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height1_Bit1    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height1_Bit1").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height1_Bit2    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height1_Bit2").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height1_Bit3    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height1_Bit3").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Left2           =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Left2").toUInt()           ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Right2          =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Right2").toUInt()          ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit26                     =m_inputs_map[oa_num][MVB2].at("bit26").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit27                     =m_inputs_map[oa_num][MVB2].at("bit27").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height2_Bit0    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height2_Bit0").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height2_Bit1    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height2_Bit1").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height2_Bit2    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height2_Bit2").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height2_Bit3    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height2_Bit3").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Left3           =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Left3").toUInt()           ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Right3          =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Right3").toUInt()          ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit34                     =m_inputs_map[oa_num][MVB2].at("bit34").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit35                     =m_inputs_map[oa_num][MVB2].at("bit35").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height3_Bit0    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height3_Bit0").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height3_Bit1    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height3_Bit1").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height3_Bit2    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height3_Bit2").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height3_Bit3    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height3_Bit3").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Left4           =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Left4").toUInt()           ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Right4          =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Right4").toUInt()          ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit42                     =m_inputs_map[oa_num][MVB2].at("bit42").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit43                     =m_inputs_map[oa_num][MVB2].at("bit43").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height4_Bit0    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height4_Bit0").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height4_Bit1    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height4_Bit1").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height4_Bit2    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height4_Bit2").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height4_Bit3    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height4_Bit3").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Left5           =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Left5").toUInt()           ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Right5          =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Right5").toUInt()          ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit50                     =m_inputs_map[oa_num][MVB2].at("bit50").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.bit51                     =m_inputs_map[oa_num][MVB2].at("bit51").toUInt()                     ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height5_Bit0    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height5_Bit0").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height5_Bit1    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height5_Bit1").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height5_Bit2    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height5_Bit2").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_Height5_Bit3    =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_Height5_Bit3").toUInt()    ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Entry1        =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Entry1").toUInt()        ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Exit1         =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Exit1").toUInt()         ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Entry2        =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Entry2").toUInt()        ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Exit2         =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Exit2").toUInt()         ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Entry3        =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Entry3").toUInt()        ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Exit3         =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Exit3").toUInt()         ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Entry4        =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Entry4").toUInt()        ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Exit4         =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Exit4").toUInt()         ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Entry5        =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Entry5").toUInt()        ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.OBU_TR_SP_D_Exit5         =m_inputs_map[oa_num][MVB2].at("OBU_TR_SP_D_Exit5").toUInt()         ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.reserved29                =m_inputs_map[oa_num][MVB2].at("reserved29").toUInt()                ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.reserved30                =m_inputs_map[oa_num][MVB2].at("reserved30").toUInt()                ;
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb2.bits.reserved31                =m_inputs_map[oa_num][MVB2].at("reserved31").toUInt()                ;
...
void Oa_Etcs::set_struct_mvb3(OA_VEHICLE_NUM oa_x_num)
{
    ...
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.Lifesign =m_inputs_map[oa_num][MVB3].at("Lifesign").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.Valid=m_inputs_map[oa_num][MVB3].at("Valid").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.bit2=m_inputs_map[oa_num][MVB3].at("bit2").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.bit3=m_inputs_map[oa_num][MVB3].at("bit3").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.bit4=m_inputs_map[oa_num][MVB3].at("bit4").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.bit5=m_inputs_map[oa_num][MVB3].at("bit5").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.bit6=m_inputs_map[oa_num][MVB3].at("bit6").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.bit7=m_inputs_map[oa_num][MVB3].at("bit7").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_ID1=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_ID1").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_TYPE1=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_TYPE1").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_ENTRY1=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_ENTRY1").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_EXIT1=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_EXIT1").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_ID2=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_ID2").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_TYPE2=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_TYPE2").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_ENTRY2=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_ENTRY2").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_EXIT2=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_EXIT2").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_ID3=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_ID3").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_TYPE3=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_TYPE3").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_ENTRY3=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_ENTRY3").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_EXIT3=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_EXIT3").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_ID4=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_ID4").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OB_TR_TC_TYPE4=m_inputs_map[oa_num][MVB3].at("OB_TR_TC_TYPE4").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_ENTRY4=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_ENTRY4").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.OBU_TR_D_EXIT4=m_inputs_map[oa_num][MVB3].at("OBU_TR_D_EXIT4").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.reserved27=m_inputs_map[oa_num][MVB3].at("reserved27").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.reserved28=m_inputs_map[oa_num][MVB3].at("reserved28").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.reserved29=m_inputs_map[oa_num][MVB3].at("reserved29").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.reserved30=m_inputs_map[oa_num][MVB3].at("reserved30").toUInt();
    m_oa_x_etcs[oa_num].oa_etcs_ccu_mvb3.bits.reserved31=m_inputs_map[oa_num][MVB3].at("reserved31").toUInt();
...
void Oa_Etcs::init_etcs_ccu_mvb1_table(OA_VEHICLE_NUM vehicle_type)
{
    ...
    m_inputs_map[oa_num][MVB1] = {
        ...
        {"EB1_Test_Output", 0},
        {"EB2_Test_Output", 0},
        {"Train_Number[12]", QVariant(QString(""))},
        {"reserved31", 0}
    };
    ...
    for (const auto& pair: m_inputs_map[oa_num][MVB1]) {
        ...
        QTableWidgetItem *item_val = new QTableWidgetItem(QString("%1").arg(pair.second.toString())); // Parametre değeri
