...
void Ska_Bcu::update_mvb1_map(SKA_VEHICLE_NUM ska_x_num)
{
    ...
    m_inputs_map[ska_num][MVB1].at("reserved22")       = m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1.bits.reserved22;
...
void Ska_Bcu::set_struct_mvb1(SKA_VEHICLE_NUM ska_x_num)
{
    ...
    m_ska_x_bcu[ska_num].ska_bcu_ccu_mvb1.bits.reserved22          =     m_inputs_map[ska_num][MVB1].at("reserved22");
